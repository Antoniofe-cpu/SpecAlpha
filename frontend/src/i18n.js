...
const STR = {
    it: {
        ...
        'landing.title_c': '',
        'landing.title_d': '',
        'landing.subtitle': 'Tutto quello che dichiara il CFTC, su una pagina sola.',
        'landing.stat1_v': '30+',
        'landing.stat1_l': 'Anni di archivio CFTC',
        'landing.stat2_v': '12M+',
        'landing.stat2_l': 'Contratti analizzati',
        'landing.stat3_v': '18',
        'landing.stat3_l': 'Asset coperti',
        'landing.stat4_v': 'CFTC',
        'landing.stat4_l': 'Fonte ufficiale',
    ...
    en: {
        ...
        'landing.title_c': '',
        'landing.title_d': '',
        'landing.subtitle': 'Everything the CFTC reports, on a single page.',
        'landing.stat1_v': '30+',
        'landing.stat1_l': 'Years of CFTC archive',
        'landing.stat2_v': '12M+',
        'landing.stat2_l': 'Contracts analyzed',
        'landing.stat3_v': '18',
        'landing.stat3_l': 'Assets covered',
        'landing.stat4_v': 'CFTC',
        'landing.stat4_l': 'Official source',
