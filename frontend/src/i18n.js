...
const STR = {
    it: {
        ...
        'modal.perf_title': 'Signal Accuracy Backtest',
        'modal.show': 'Mostra',
        'modal.hide': 'Nascondi',
        'modal.perf_logic':
            'Metodo: per ogni report COT della settimana A, si osserva l\'azione del prezzo nella settimana successiva A+1 (lun-ven). Il segnale è "rispettato" se la direzione prevista è stata confermata chronologically: per LONG il minimo settimanale deve arrivare PRIMA del massimo; per SHORT il massimo deve arrivare PRIMA del minimo. Nessun entry/exit simulato — misura pura di qualità predittiva del segnale.',
        'modal.perf_synth_note':
            'Disclaimer: questa metrica NON è un backtest di trading (non include entry, stop, slippage o fees). Misura solo quanto frequentemente la direzione del segnale COT si è verificata nella settimana successiva. Utile per confrontare la qualità dei filtri tra loro e per valutare la robustezza predittiva su diversi asset. Un accuracy >55% è considerato rilevante; 50% è random.',
        'modal.perf_loading': 'Calcolo signal accuracy…',
        ...
        'modal.perf.window_12w': 'Ultime 12 settimane (3 mesi)',
        'modal.perf.window_24w': 'Ultime 24 settimane (6 mesi)',
    ...
    en: {
        ...
        'modal.hide': 'Hide',
        'modal.perf_logic':
            'Method: for each COT report on week A, we observe price action during the following week A+1 (Mon-Fri). The signal is "respected" if its direction was confirmed chronologically: for LONG the weekly low must come BEFORE the weekly high; for SHORT the weekly high must come BEFORE the weekly low. No simulated entry/exit — pure predictive quality measurement.',
        'modal.perf_synth_note':
            'Disclaimer: this metric is NOT a trading backtest (no entry, stop, slippage or fees). It only measures how often the direction of the COT signal was confirmed in the following week. Useful to compare filter quality and to assess predictive robustness across assets. Accuracy >55% is meaningful; 50% is random.',
        'modal.perf_loading': 'Computing signal accuracy…',
        'modal.perf.mode_lts': 'LONG-TERM & SHORT-TERM',
        'modal.perf.mode_st': 'SHORT-TERM',
        ...
        'modal.perf.window_12w': 'Last 12 weeks (3 months)',
        'modal.perf.window_24w': 'Last 24 weeks (6 months)',
        'modal.perf.accuracy': 'Accuracy',
