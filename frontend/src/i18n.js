...
const STR = {
    it: {
        ...
        'landing.title_a': 'Dati oggettivi',
        'landing.title_b': 'per leggere i mercati.',
        'landing.title_c': '',
        'landing.title_d': '',
        'landing.subtitle': 'Ogni traccia dei pi\u00f9 grandi speculatori, in un\u2019unica piattaforma.',
        ...
        'landing.pillar2_d': 'Put/Call ratio, max pain, gamma walls. Dove il market making concentra il rischio.',
        'landing.pillar3_t': 'Indici, commodities, forex',
        'landing.pillar3_d': '18 asset in copertura: S&P, Nasdaq, oro, petrolio, EUR, USD, JPY, AUD e altri.',
        'landing.pillar4_t': 'Confluence Index',
        'landing.pillar4_d': 'Score 0–100 calcolato solo su dati oggettivi. Niente opinioni, niente sentiment.',
        'opp.strong_setup': 'Setup forte',
        'common.unlock': 'Sblocca',
        'landing.cta_pulse_a': '7 giorni gratis, poi \u20ac19.90/mese',
        'landing.cta_pulse_b': 'Apri la dashboard',
        'landing.cta_meta': 'Carta richiesta · cancelli quando vuoi · senza vincoli',
        'landing.features_kicker': "Tutto in un'unica dashboard",
        'landing.features_title': 'Questi tool ti faranno la differenza',
        ...
        'landing.cta2_desc': "Esplora gli asset con la prova gratuita. 7 giorni, cancelli quando vuoi prima della fine del periodo.",
        ...
        'app.start_trial': 'Inizia la prova',
        'app.trial_pending': 'In sincronizzazione…',
        'app.trial_pending_hint': 'Stiamo confermando il tuo abbonamento con Stripe. Aggiorna la pagina tra qualche secondo.',
        'app.account': 'Account',
        // -------- Account page --------
        'account.kicker': 'Account',
        'account.title': 'Il tuo profilo',
        'account.back_to_dashboard': 'Torna alla dashboard',
        'account.logout': 'Esci',
        'account.profile_title': 'Profilo',
        'account.email': 'Email',
        'account.name': 'Nome',
        'account.member_since': 'Iscritto dal',
        'account.role': 'Ruolo',
        'account.role_user': 'Utente',
        'account.subscription_title': 'Abbonamento',
        'account.current_plan': 'Piano attuale',
        'account.plan': 'Piano',
        'account.price': 'Prezzo',
        'account.price_free': 'Gratis',
        'account.plan_pro': 'Pro · attivo',
        'account.plan_trial': 'Pro · in prova gratuita',
        'account.plan_free': 'Free',
        'account.plan_past_due': 'Pagamento in sospeso',
        'account.plan_canceled': 'Annullato',
        'account.badge_pro': 'PRO ATTIVO',
        'account.badge_trial': 'IN PROVA GRATUITA',
        'account.badge_free': 'FREE',
        'account.badge_past_due': 'PAGAMENTO IN SOSPESO',
        'account.badge_canceled': 'ANNULLATO',
        'account.trial_ends': 'La prova scade il',
        'account.trial_ends_short': 'Scade il',
        'account.next_billing': 'Prossimo addebito',
        'account.access_until': 'Accesso fino al',
        'account.cancel_status': 'Stato annullamento',
        'account.cancel_status_value': 'Annullamento programmato a fine periodo',
        'account.cta_start_trial': 'Inizia la prova gratuita',
        'account.cta_subscribe': 'Sottoscrivi ora',
        'account.cta_manage': 'Gestisci su Stripe',
        'account.cta_resubscribe': 'Riattiva abbonamento',
        'account.price_value': '\u20ac19.90 / mese',
        'account.trial_already_used': 'Hai già usato la prova gratuita di 7 giorni. Sottoscrivendo ora l\u2019addebito di €19.90 parte immediatamente.',
        'app.subscribe': 'Sottoscrivi',
        'account.manage_hint': 'Per cambiare metodo di pagamento, scaricare le fatture o annullare l\u2019abbonamento usa il portale sicuro di Stripe. Tutte le modifiche sono immediate.',
        'account.stats_title': 'Statistiche',
        'account.favorites': 'Asset preferiti',
        'account.user_id': 'ID utente',
        'account.access_level': 'Livello d\u2019accesso',
        'auth.login_kicker': 'Accedi',
        'auth.register_kicker': 'Registrati',
        'auth.login_title': 'Bentornato',
        'auth.register_title': 'Crea il tuo account',
        'auth.login_subtitle': 'Accedi per sbloccare il Confluence Index completo.',
        'auth.register_subtitle': '7 giorni di prova gratuita. Annulla quando vuoi.',
        'auth.google_btn': 'Continua con Google',
        'auth.or': 'oppure',
        'auth.name_ph': 'Nome',
        'auth.email_ph': 'Email',
        'auth.password_ph': 'Password (min 8)',
        'auth.submit_login': 'Accedi',
        'auth.submit_register': 'Crea account',
        'auth.switch_to_register_q': 'Non hai un account?',
        'auth.switch_to_register_cta': 'Registrati',
        'auth.switch_to_login_q': 'Hai già un account?',
        'auth.switch_to_login_cta': 'Accedi',
    ...
    en: {
        ...
        // Landing
        'landing.kicker': 'Trader Intelligence',
        'landing.title_a': 'Objective data',
        'landing.title_b': 'to read the markets.',
        'landing.title_c': '',
        'landing.title_d': '',
        'landing.subtitle': "Every footprint of the biggest speculators, in one platform.",
        'landing.pillar1_t': 'COT Report',
        ...
        'landing.pillar2_d': 'Put/Call ratio, max pain, gamma walls. Where market making concentrates risk.',
        'landing.pillar3_t': 'Indices, commodities, forex',
        'landing.pillar3_d': '18 assets covered: S&P, Nasdaq, gold, oil, EUR, USD, JPY, AUD and more.',
        'landing.pillar4_t': 'Confluence Index',
        'landing.pillar4_d': '0–100 score built only on objective data. No opinions, no sentiment.',
        'opp.strong_setup': 'Strong setup',
        'common.unlock': 'Unlock',
        'landing.cta_pulse_a': '7 days free, then $24.99/month',
        'landing.cta_pulse_b': 'Open the dashboard',
        'landing.cta_meta': 'Card required \u00b7 cancel anytime \u00b7 no lock-in',
        'landing.features_kicker': 'All in one dashboard',
        'landing.features_title': 'These tools will make the difference',
        'landing.feat1_t': 'Confluence Index',
        ...
        'landing.cta2_desc': 'Explore the assets with the free trial. 7 days, cancel anytime before it ends.',
        ...
        'app.signup': 'Sign up',
        'app.start_trial': 'Start free trial',
        'app.trial_pending': 'Syncing\u2026',
        'app.trial_pending_hint': "We're confirming your subscription with Stripe. Refresh the page in a few seconds.",
        'app.account': 'Account',
        // -------- Account page --------
        'account.kicker': 'Account',
        ...
        'account.subscription_title': 'Subscription',
        'account.current_plan': 'Current plan',
        'account.plan': 'Plan',
        'account.price': 'Price',
        'account.price_free': 'Free',
        'account.plan_pro': 'Pro \u00b7 active',
        'account.plan_trial': 'Pro \u00b7 free trial',
        'account.plan_free': 'Free',
        'account.plan_past_due': 'Payment past due',
        'account.plan_canceled': 'Canceled',
        'account.badge_pro': 'PRO ACTIVE',
        'account.badge_trial': 'FREE TRIAL',
        'account.badge_free': 'FREE',
        'account.badge_past_due': 'PAYMENT PAST DUE',
        'account.badge_canceled': 'CANCELED',
        'account.trial_ends': 'Trial ends on',
        'account.trial_ends_short': 'Ends',
        'account.next_billing': 'Next billing date',
        'account.access_until': 'Access until',
        'account.cancel_status': 'Cancellation',
        'account.cancel_status_value': 'Scheduled at the end of the period',
        'account.cta_start_trial': 'Start 7-day free trial',
        'account.cta_subscribe': 'Subscribe now',
        'account.cta_manage': 'Manage on Stripe',
        'account.cta_resubscribe': 'Resubscribe',
        'account.price_value': '$24.99 / month',
        'account.trial_already_used': 'You\u2019ve already used your 7-day free trial. Subscribing now charges $24.99 immediately.',
        'app.subscribe': 'Subscribe',
        'account.manage_hint': 'To change your payment method, download invoices or cancel your subscription, use the secure Stripe portal. All changes apply immediately.',
        'account.stats_title': 'Stats',
        'account.favorites': 'Saved assets',
        'account.user_id': 'User ID',
        'account.access_level': 'Access level',
        'auth.login_kicker': 'Sign in',
        'auth.register_kicker': 'Sign up',
        'auth.login_title': 'Welcome back',
        'auth.register_title': 'Create your account',
        'auth.login_subtitle': 'Sign in to unlock the full Confluence Index.',
        'auth.register_subtitle': '7-day free trial. Cancel anytime.',
        ...
        'auth.switch_to_register_q': "Don\u2019t have an account?",
        'auth.switch_to_register_cta': 'Sign up',
        'auth.switch_to_login_q': 'Already have an account?',
        'auth.switch_to_login_cta': 'Sign in',
        'landing.header_dashboard': 'Dashboard',
