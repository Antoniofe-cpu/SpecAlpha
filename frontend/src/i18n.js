...
const STR = {
    it: {
        ...
        'landing.cta_meta': 'Nessuna carta richiesta per iniziare \u00b7 cancelli quando vuoi',
    ...
    en: {
        ...
        'landing.cta_pulse_a': '7 days free, then $19.90/month',
        'landing.cta_pulse_b': 'Open the dashboard',
        'landing.cta_meta': 'No card required to start \u00b7 cancel anytime',
        ...
        'account.price_value': '$19.90 / month',
        'account.trial_already_used': 'You\u2019ve already used your 7-day free trial. Subscribing now charges $19.90 immediately.',
