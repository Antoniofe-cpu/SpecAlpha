...
const STR = {
    it: {
        ...
        'landing.stat1_v': '$2T+',
        'landing.stat1_l': 'Open Interest monitorato',
        'landing.stat2_v': '63',
        'landing.stat2_l': 'Anni di storico COT',
        'landing.stat3_v': 'F+1',
        'landing.stat3_l': 'Aggiornato post release CFTC',
        'landing.stat4_v': 'CEA',
        'landing.stat4_l': 'Dato regolamentato',
    ...
    en: {
        ...
        'landing.stat1_v': '$2T+',
        'landing.stat1_l': 'Open Interest tracked',
        'landing.stat2_v': '63',
        'landing.stat2_l': 'Years of COT history',
        'landing.stat3_v': 'F+1',
        'landing.stat3_l': 'After every CFTC release',
        'landing.stat4_v': 'CEA',
        'landing.stat4_l': 'Regulated data',
